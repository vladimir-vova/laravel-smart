...
window._s3Lang['FIND_LOST_IMAGE_WARNING'] = "Предупреждение: Если на сайте имеются иллюстрации, которые не открываются (или отдают 404 ошибку) - они будут удалены из раздела \"Иллюстрации\"";
...
window._s3Lang['JS_CREATE_BACKUP'] = "Создать бэкап";
...
window._s3Lang['LP_VIDEO_TYPE'] = "Тип фона";
...
window._s3Lang['SHOP2_BONUS'] = "Бонусная система";
